...
export default class Kalmegh extends React.Component {
  render() {
    return (
      <View
        style={{ backgroundColor: '#ccfffd', width:'100%', height:'100%'}}>
        <PlantHeader title="Kalmegh" navigation={this.props.navigation}/>
        <Image
        ...
        <View
          ...
          <Text style={[styles.pName, {marginBottom:10, fontSize:21}]}> Kalmegh </Text>
          <Text style={[styles.bName, {textDecorationLine:'underline', fontSize:22}]}> Botanical Name </Text>
          <Text style={[styles.bName, {marginBottom:10, fontSize:21}]}> Andrographis Paniculata Pennel </Text>
          <Text style={[styles.mUse, {textDecorationLine:'underline', fontSize:22}]}> Medicinal Use </Text>
          <Text style={[styles.mUse, {fontSize:21}]}> Acne, Diarrhea </Text>
        </View>
      </View>
    );
  }
